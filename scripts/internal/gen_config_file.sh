...
#
#   [SOURCE/TARGET]_BLUETOOTH_SUPPORT_A2DP_OFFLOAD
#     Boolean which describes whether the device supports Bluetooth A2DP offload.
#
...
#     Boolean which describes whether the device supports Wi-Fi to Cellular.
{
    ...
    GET_BUILD_VAR "SOURCE_BLUETOOTH_SUPPORT_A2DP_OFFLOAD"
    GET_BUILD_VAR "TARGET_BLUETOOTH_SUPPORT_A2DP_OFFLOAD"
